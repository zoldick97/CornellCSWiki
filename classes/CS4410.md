...
--------------------------
This class is a mess. From autograders that don't even work to projects designed by only one TA, 4410 is outright frustrating and appalling. Lectures have little to no overlap with projects; doing well on assignments doesn't guarantee you know the 9001 trivia questions asked on the prelims. The piazza is barren of instructor help, with the only responses to questions coming from fellow students. Recitations are poorly organized as well; at times, the TA would not even know how to explain an answer to a question. There were multiple times in OH where I would go for help only to have a TA tell me they did not know how to help. I don't think any student should be subject to this type of mess, and I really hope for the sake of Cornell's Computer Science department that changes are made FAST, because CS 4410 exemplifies nothing remotely close to a class run by an Ivy League institution.
